...
<template>
  <Teleport to="body">
    ...
    >
      <div class="max-w-md w-full bg-judge-panel border border-white/10 rounded-2xl shadow-2xl p-6 animate-[fadeIn_.15s_ease-out]">
        ...
        <button
          class="mt-5 w-full rounded-xl bg-judge-accent hover:bg-judge-accent/90 text-white font-semibold py-2.5 transition"
          @click="emit('close')"
        >
          Got it
        </button>
